...
const menuItems = [
  ...
  { label: "Hotels & Restaurants", title: "Stay & Dine", subtitle: "Discover comfort and taste", icon: "bi-building", href: "/hotels&restaurants" },
              ...
              <div key={item.label}>
                {item.isLogout ? (
                  <button
                    ...
                    className="block w-full px-6 py-3 flex items-center gap-3 transition-all rounded-md mx-3 my-2 bg-gradient-to-r from-red-700 to-red-500 text-white hover:from-red-600 hover:to-red-400"
                  >
